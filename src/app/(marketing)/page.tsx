        ...
        <div className='mx-auto max-w-7xl'>
          ...
          >
            ...
            <p className='mx-auto mb-12 max-w-2xl text-lg text-gray-400'>
              Built on Core's Bitcoin-aligned blockchain for secure and scalable
              BTCfi applications
            </p>
          </motion.div>
              ...
              <CardContent className='space-y-4'>
                <div className='space-y-2'>
                  <div className='flex items-center gap-2'>
                    ...
                    <span className='text-sm'>Satoshi Plus Consensus</span>
                  </div>
                  <div className='flex items-center gap-2'>
                    <CheckCircle2 className='h-4 w-4 text-green-400' />
                    <span className='text-sm'>EVM Compatibility</span>
                  </div>
                  <div className='flex items-center gap-2'>
                    <CheckCircle2 className='h-4 w-4 text-green-400' />
                    <span className='text-sm'>BTCfi Native Support</span>
                  </div>
                  <div className='flex items-center gap-2'>
                    <CheckCircle2 className='h-4 w-4 text-green-400' />
                    <span className='text-sm'>Bitcoin Hash Power Security</span>
                  </div>
                </div>
                <div className='rounded-lg bg-blue-950/40 p-3'>
                  <p className='text-xs text-blue-300'>
                    Optimized for BTCfi and DeFi applications with Bitcoin-level
                    security and high throughput
                  </p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className='border-purple-500/30 bg-gradient-to-br from-purple-950/30 to-pink-950/30 backdrop-blur-sm'>
              ...
              <CardContent className='space-y-4'>
                <div className='space-y-2'>
                  <div className='flex items-center gap-2'>
                    <CheckCircle2 className='h-4 w-4 text-green-400' />
                    <span className='text-sm'>3 Second Block Time</span>
                  </div>
                  <div className='flex items-center gap-2'>
                    <CheckCircle2 className='h-4 w-4 text-green-400' />
                  ...
                  <div className='flex items-center gap-2'>
                    <CheckCircle2 className='h-4 w-4 text-green-400' />
                    <span className='text-sm'>Bitcoin-Aligned Security</span>
                  </div>
                  <div className='flex items-center gap-2'>
                    <CheckCircle2 className='h-4 w-4 text-green-400' />
                    <span className='text-sm'>High Throughput Capacity</span>
                  </div>
                </div>
                <div className='rounded-lg bg-purple-950/40 p-3'>
                  <p className='text-xs text-purple-300'>
                    Enterprise-grade performance for BTCfi and DeFi applications
                  </p>
                </div>
              </CardContent>
            </Card>
