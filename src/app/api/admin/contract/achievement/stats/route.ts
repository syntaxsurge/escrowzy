  ...
  try {
      ...
      return NextResponse.json(
        {
          ...
          supportedChains: ['Base Sepolia', 'Etherlink Testnet']
        },
        { status: 404 }
      )
    }
    ...
    const recentMints = recentEvents
      ...
      .map((event: any) => ({
        ...
        recipient:
          event.args?.recipient || '0x0000000000000000000000000000000000000000',
    ...
    let baseUri = 'https://api.yourapp.com/metadata/'
    try {
